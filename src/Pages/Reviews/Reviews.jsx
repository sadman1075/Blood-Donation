        ...
        <div>
            <div className=' mb-20 mt-20'>
                ...
                <div>
                    ...
                    <p className='text-center mt-5'>This app is praised for its user-friendly interface, allowing donors to schedule and manage appointments easily. Users appreciate features like RapidPass, which streamlines the donation process, and the ability to track where their blood is utilized. One user noted, 'Great for scheduling. Great for Rapid Pass. Enjoy seeing where the blood goes</p>
                </div>
